...
import { Save, FileText, Building2, Users, MapPin, ChevronDown, Check, Activity, Clock, Trash2, FileSignature, Info, Route, UploadCloud, Image as ImageIcon, X, Hammer, PaintBucket, DoorOpen, Square, Plus, LayoutGrid, Zap, Droplets, BookOpen, CheckCircle } from 'lucide-react';
...
export default function App() {
  ...
  // ================= ESTADO FASE 2: ATENDIMENTO (LIMPO COM HORÁRIOS) =================
      ...
      <body>
        ...
        <div class="capa-container">
          ...
          <div style="text-align: center; margin: 0 0 150px 0;">
             <p style="font-size: 24pt; font-weight: bold; color: #cc0000;">[ LOGOTIPO SABIN ]</p>
          </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className={activeTab === 'ambientesEspecificos' ? "space-y-6 animate-in fade-in" : "hidden"}>
          <div className="bg-white p-6 rounded-xl shadow-sm border border-red-200">
            <h2 className="text-lg font-semibold text-red-900 mb-4 flex items-center gap-2"><LayoutGrid size={20} className="text-red-600"/> Adicionar Ambientes ao Projeto</h2>
